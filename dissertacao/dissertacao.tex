...
\titulo{Um Modelo Conceitual sobre Cenários de Acidentes } % titulo do trabalho em portugues
...
4\orientador{Cesar Augusto Tacla} 
...
\chapter{Discussão}
	...
	\section{Análise Comparativa}\label{analisecomparativa}
		...
		\input{estrutura/analisecomparativa/estcartago.tex}
