O estudo de caso desta pesquisa consiste em sete profissionais de linha viva (profissionais que realizam manutenção em equipamentos elétricos energizados) 
...
A tabela \ref{g} apresenta os objetivos dados pela coluna $objetivo$ bem com sua descrição. Essa tabela também apresenta os conjuntos $gp_i$ dado pela 
coluna pré-requisitos. Assim sendo, essa tabela também apresenta as especificações para o predicado $nextGoal(g_i,g_j)$ onde \textit{Objetivo} representa 
$g_i$, \textit{Próximo} $g_j$ e \textit{Descrição} é referente a $g_i$.
...
g12 & g10 & Amarrar o olhal do bastão universal ao cavalo da sela atrás de uma corda. \\ \hline
...
relXCapacete                                    & relParafusoTorre                                 \\ \hline
...
relXOculos                                      & relParafusoTorre                                 \\ \hline
...
relXLuva                                        & relParafusoTorre                                 \\ \hline
...
relXBotas                                       & relParafusoTorre                                 \\ \hline
...
relXPano                                        & relParafusoTorre                                 \\ \hline
...
relPanoGlicerina                                & relParafusoTorre                                 \\ \hline
...
A tabela \ref{goalsrelationsentity} define o predicado $hasRelation(g_i,rg_n)$ onde a coluna objetivo é representada por $g_i$, define o predicado  $hasEntity(g_i,eg_m)$ e o predicado $hasCondition(g_i,cg_n)$.  
