...
As tabelas \ref{goalsrelationsentity1} e \ref{goalsrelationsentity2} definem o predicado $hasRelation(g_i,rg_n)$ onde a coluna objetivo é representada por $g_i$, define o predicado  $requiresEntity(g_i,eg_m)$ e o predicado $requiresCirc(g_i,cg_n)$.  
