Esse capítulo apresenta os resultados atrelados a etapa metodológica \ref{inferencias} que tem como por finalidade validar o modelo conceitual no que tange a um cenário real de manutenção com alta potencialidade para a ocorrência de acidentes. 
