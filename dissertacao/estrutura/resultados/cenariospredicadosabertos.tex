...
\begin{itemize}
    ...
    \item $hasRisk(circ, risk_j, cs_k)$
    \item $possOfNegConseqFor(r_l)$
    \item $affectsRels(r_k,r_n)$
    \item $happensNegConseqFor(g_k, ag_i,risk_k,cs_m)$
