...
O \textit{V3S} realiza a tratativa de violações usando o estudo \cite{FADIER2003759}. Em contraste com isso, neste modelo o autor desta dissertação optou por definir as violações por intermédio de regras (definidas por meio de relações de implicabilidade) onde define claramente quais condições resultam numa determinada violação. Com base nisso, a proposta do modelo deste texto está muito mais próximo do texto \cite{dastaniNormativeMultiAgentProgram} do que do \textit{V3S}. 
